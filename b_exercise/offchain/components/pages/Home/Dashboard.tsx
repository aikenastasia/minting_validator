    ...
    NFT: {
      mint: async () => {
        try {
          ...
          submitTx(tx)
            .then((result) => {
              localStorage.setItem("mint_exercise.nft_policyid", policyID);
      ...
      burn: async () => {
        try {
          ...
          const policyID = localStorage.getItem("mint_exercise.nft_policyid");
          ...
          submitTx(tx)
            .then((result) => {
              localStorage.removeItem("mint_exercise.nft_policyid");
              props.setActionResult(result);
            })
            .catch(props.onError);
        } catch (error) {
